            ...
            <header class="mt-5">
                ...
                <nav class="d-flex justify-content-center my-5">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                        <li class="page-item"><a class="page-link" href="{{url('/myview3')}}">Previous</a></li>
                        ...
                        <li class="page-item"><a class="page-link" href="{{url('myview2')}}">Next</a></li>
                        </ul>
                    </nav>
                </nav>
            </header>
            <div class="container d-flex justify-content-center">
                <p class="h1">My view 1</p>
            </div>
